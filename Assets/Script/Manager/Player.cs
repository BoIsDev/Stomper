...
public class Player : MonoBehaviour, IDameReciever
{
    ...
    protected void HandleMovementInput()
    {
        ...
        if (xDirection > 0 && !Flip.Instance.isFacingRight || xDirection < 0 && Flip.Instance.isFacingRight)
        {
    ...
    {
        if (Input.GetKeyDown(KeyCode.Space) && isSetJumping)
        {
    ...
    private void HandleRollInput()
    {
        ...
        if (isRoll && Input.GetKey(KeyCode.J))
        {
